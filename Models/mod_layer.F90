module mod_layer
  ...
  type :: layer_type
    ...
    real(KDR), allocatable :: i(:)          ! store layer input
    real(KDR), allocatable :: b(:)          ! biases
    real(KDR), allocatable :: o(:)          ! output
    real(KDR), allocatable :: gradient(:)   ! gradients
    real(KDR), allocatable :: w(:,:)        ! weights
    real(KDR), allocatable :: z(:)          ! arg. to activation function
    real(KDR), allocatable :: beta(:)
    real(KDR), allocatable :: gama(:)
    real(KDR), allocatable :: mean(:)
    real(KDR), allocatable :: variance(:)
  contains
